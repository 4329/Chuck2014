...
<Project Type="Project" LVVersion="13008000">
	...
	<Property Name="NI.Project.Description" Type="Str">FRC 4329 Season 2014</Property>
	...
	<Item Name="RT CompactRIO Target" Type="RT CompactRIO">
		...
		<Property Name="alias.value" Type="Str">10.43.29.2</Property>
...
DirectoryIndex index.htm
		...
		<Item Name="Configure" Type="Folder">
			<Item Name="Configure - DMR.vi" Type="VI" URL="../Configure/Configure - DMR.vi"/>
			<Item Name="Configure - DML.vi" Type="VI" URL="../Configure/Configure - DML.vi"/>
		</Item>
		<Item Name="Create" Type="Folder">
			<Item Name="Create - DML.vi" Type="VI" URL="../Create/Create - DML.vi"/>
			<Item Name="Create - DMR.vi" Type="VI" URL="../Create/Create - DMR.vi"/>
		</Item>
		<Item Name="Systems" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="System.lvclass" Type="LVClass" URL="../Systems/System/System.lvclass"/>
			<Item Name="ArcadeMode.vi" Type="VI" URL="../Systems/ArcadeMode.vi"/>
			<Item Name="Catapult.lvclass" Type="LVClass" URL="../Systems/Catapult/Catapult.lvclass"/>
			<Item Name="Compressor.lvclass" Type="LVClass" URL="../Systems/Compressor/Compressor.lvclass"/>
			<Item Name="DriveMotors.lvclass" Type="LVClass" URL="../Systems/DriveMotors/DriveMotors.lvclass"/>
			<Item Name="Driver.vi" Type="VI" URL="../Systems/Driver.vi"/>
			<Item Name="DriverStation.lvclass" Type="LVClass" URL="../Systems/DriverStation/DriverStation.lvclass"/>
			<Item Name="DriverXBoxController.lvclass" Type="LVClass" URL="../Systems/DriverXBoxController/DriverXBoxController.lvclass"/>
			<Item Name="GrabberArms.lvclass" Type="LVClass" URL="../Systems/GrabberArms/GrabberArms.lvclass"/>
			<Item Name="GrabberWheels.lvclass" Type="LVClass" URL="../Systems/GrabberWheels/GrabberWheels.lvclass"/>
			<Item Name="Operator.vi" Type="VI" URL="../Systems/Operator.vi"/>
			<Item Name="OperatorXBoxController.lvclass" Type="LVClass" URL="../Systems/OperatorXBoxController/OperatorXBoxController.lvclass"/>
			<Item Name="Robot.lvclass" Type="LVClass" URL="../Systems/Robot/Robot.lvclass"/>
			<Item Name="Shifter.lvclass" Type="LVClass" URL="../Systems/Shifter/Shifter.lvclass"/>
			<Item Name="XBoxController.lvclass" Type="LVClass" URL="../Systems/XboxController/XBoxController.lvclass"/>
			<Item Name="Blocker.lvclass" Type="LVClass" URL="../Systems/Blocker/Blocker.lvclass"/>
		</Item>
		<Item Name="Commands" Type="Folder">
			<Item Name="Command" Type="Folder">
				<Item Name="Command.lvclass" Type="LVClass" URL="../Commands/Command/Command.lvclass"/>
			</Item>
			<Item Name="DM-Drive Motor Commands" Type="Folder">
				<Item Name="DM-SetPower-Command.lvclass" Type="LVClass" URL="../Commands/DM-SetPower-Command/DM-SetPower-Command.lvclass"/>
				<Item Name="DM-DriveForwardDistance.lvclass" Type="LVClass" URL="../Commands/DM-DriveForwardDistance/DM-DriveForwardDistance.lvclass"/>
			</Item>
			<Item Name="SF-Shifter Commands" Type="Folder">
				<Item Name="SF-ShiftLow-Cmd.lvclass" Type="LVClass" URL="../Commands/Shifter-ShiftLow-Cmd/SF-ShiftLow-Cmd.lvclass"/>
				<Item Name="SF-ShiftHigh-Cmd.lvclass" Type="LVClass" URL="../Commands/Shifter-ShiftHigh-Cmd/SF-ShiftHigh-Cmd.lvclass"/>
			</Item>
			<Item Name="GA-GrabberArms Commands" Type="Folder">
				<Item Name="GA-Extend-Cmd.lvclass" Type="LVClass" URL="../Commands/GA-Extend-Command/GA-Extend-Cmd.lvclass"/>
				<Item Name="GA-Retract-Cmd.lvclass" Type="LVClass" URL="../Commands/GA-Retract-Command/GA-Retract-Cmd.lvclass"/>
			</Item>
			<Item Name="GW-GrabberWheels Commands" Type="Folder">
				<Item Name="GW-PickUp-Cmd.lvclass" Type="LVClass" URL="../Commands/GW-PickUp-Command/GW-PickUp-Cmd.lvclass"/>
				<Item Name="GW-SpitOut-Cmd.lvclass" Type="LVClass" URL="../Commands/GW-SpitOut-Command/GW-SpitOut-Cmd.lvclass"/>
				<Item Name="GW-Stop-Cmd.lvclass" Type="LVClass" URL="../Commands/GW-Stop-Command/GW-Stop-Cmd.lvclass"/>
				<Item Name="GW-PickUp(Half)-Cmd.lvclass" Type="LVClass" URL="../Commands/GW-PickUp(Half)-Command/GW-PickUp(Half)-Cmd.lvclass"/>
			</Item>
			<Item Name="CT-Catapult Commands" Type="Folder">
				<Item Name="CT-Energize-Cmd.lvclass" Type="LVClass" URL="../Commands/CT-Energize-Cmd/CT-Energize-Cmd.lvclass"/>
				<Item Name="CT-De-energize-Cmd.lvclass" Type="LVClass" URL="../Commands/CT-De-energize-Command/CT-De-energize-Cmd.lvclass"/>
				<Item Name="CT-Stop-Cmd.lvclass" Type="LVClass" URL="../Commands/CT-Stop-Command/CT-Stop-Cmd.lvclass"/>
				<Item Name="CT-De-energizeThenStop-Cmd.lvclass" Type="LVClass" URL="../Commands/CT-De-energizeThenStop-Command/CT-De-energizeThenStop-Cmd.lvclass"/>
			</Item>
			<Item Name="BL-Blocker Commands" Type="Folder">
				<Item Name="BL-Extend-Cmd.lvclass" Type="LVClass" URL="../Commands/BL-Extend-Command/BL-Extend-Cmd.lvclass"/>
				<Item Name="BL-Retract-Cmd.lvclass" Type="LVClass" URL="../Commands/BL-Retract-Command/BL-Retract-Cmd.lvclass"/>
			</Item>
		</Item>
		<Item Name="States" Type="Folder">
			...
			<Item Name="DM-DriveForwardDistance (DFD)" Type="Folder">
				<Item Name="DM-DFD-Starting-State.lvclass" Type="LVClass" URL="../States/DM-DFD-Starting-State/DM-DFD-Starting-State.lvclass"/>
				<Item Name="DMD-DFD-Driving-State.lvclass" Type="LVClass" URL="../States/DM-DFD-Driving-State/DMD-DFD-Driving-State.lvclass"/>
				<Item Name="DM-DFD-StopAtDistance-State.lvclass" Type="LVClass" URL="../States/DM-DFD-StopAtDistance-State/DM-DFD-StopAtDistance-State.lvclass"/>
			</Item>
			<Item Name="DM-SetPower" Type="Folder">
				<Item Name="DM-MaintainPower-State.lvclass" Type="LVClass" URL="../States/DM-MaintainPower-State/DM-MaintainPower-State.lvclass"/>
			</Item>
			<Item Name="SF-Shifter States" Type="Folder">
				<Item Name="Shifter-LowSpeed.lvclass" Type="LVClass" URL="../States/SF-LowSpeed-State/Shifter-LowSpeed.lvclass"/>
				<Item Name="Shifter-HighSpeed.lvclass" Type="LVClass" URL="../States/SF-HighSpeed-State/Shifter-HighSpeed.lvclass"/>
			</Item>
			<Item Name="GA-GrabberArmsStates" Type="Folder">
				<Item Name="GrabberArms-ExtendedState.lvclass" Type="LVClass" URL="../States/GA-Extended-State/GrabberArms-ExtendedState.lvclass"/>
				<Item Name="GrabberArms-ExtendingState.lvclass" Type="LVClass" URL="../States/GA-Extending-State/GrabberArms-ExtendingState.lvclass"/>
				<Item Name="GrabberArms-RetractedState.lvclass" Type="LVClass" URL="../States/GA-Retracted-State/GrabberArms-RetractedState.lvclass"/>
				<Item Name="GrabberArms-RetractingState.lvclass" Type="LVClass" URL="../States/GA-Retracting-State/GrabberArms-RetractingState.lvclass"/>
			</Item>
			<Item Name="GW-GrabberWheelsStates" Type="Folder">
				<Item Name="GW-PickingUp-State.lvclass" Type="LVClass" URL="../States/GW-PickingUp-State/GW-PickingUp-State.lvclass"/>
				<Item Name="GW-Stopping-State.lvclass" Type="LVClass" URL="../States/GW-Stopping-State/GW-Stopping-State.lvclass"/>
				<Item Name="GW-SpittingOut-State.lvclass" Type="LVClass" URL="../States/GW-SpittingOut-State/GW-SpittingOut-State.lvclass"/>
				<Item Name="GW-PickingUp(half)-State.lvclass" Type="LVClass" URL="../States/GW-PickingUp(Half)-State/GW-PickingUp(half)-State.lvclass"/>
			</Item>
			<Item Name="CT-CatapultStates" Type="Folder">
				<Item Name="CT-Energizing-State.lvclass" Type="LVClass" URL="../States/CT-Energizing-State/CT-Energizing-State.lvclass"/>
				<Item Name="CT-Energized-State.lvclass" Type="LVClass" URL="../States/CT-Energized-State/CT-Energized-State.lvclass"/>
				<Item Name="CT-De-Energizing-State.lvclass" Type="LVClass" URL="../States/CT-De-Energizing-State/CT-De-Energizing-State.lvclass"/>
				<Item Name="CT-De-Energized-State.lvclass" Type="LVClass" URL="../States/CT-De-Energized-State/CT-De-Energized-State.lvclass"/>
				<Item Name="CT-Stopping-State.lvclass" Type="LVClass" URL="../States/CT-Stopping-State/CT-Stopping-State.lvclass"/>
				<Item Name="CT-GrabberInWay-State.lvclass" Type="LVClass" URL="../States/CT-GrabberInWay-State/CT-GrabberInWay-State.lvclass"/>
			</Item>
			<Item Name="BL-States" Type="Folder">
				<Item Name="BL-Extending-State.lvclass" Type="LVClass" URL="../States/BL-Extending-State/BL-Extending-State.lvclass"/>
				<Item Name="BL-Retracting-State.lvclass" Type="LVClass" URL="../States/BL-Retracting-State/BL-Retracting-State.lvclass"/>
			</Item>
		</Item>
		<Item Name="Controllers" Type="Folder">
			<Item Name="Blocker Controller.vi" Type="VI" URL="../Blocker Controller.vi"/>
			<Item Name="Shifter Controller.vi" Type="VI" URL="../Shifter Controller.vi"/>
			<Item Name="GrabberArms Controller.vi" Type="VI" URL="../GrabberArms Controller.vi"/>
			<Item Name="GrabberWheels Controller.vi" Type="VI" URL="../GrabberWheels Controller.vi"/>
			<Item Name="Catapult Controller.vi" Type="VI" URL="../Catapult Controller.vi"/>
		</Item>
		<Item Name="Utilities" Type="Folder">
			<Item Name="Error to String.vi" Type="VI" URL="../Utilities/Error to String.vi"/>
			<Item Name="Boolean to String.vi" Type="VI" URL="../Commands/DM-SetPower-Command/Boolean to String.vi"/>
			<Item Name="Adjust to Deadzone.vi" Type="VI" URL="../Utilities/Adjust to Deadzone.vi"/>
		</Item>
		<Item Name="Support Code" Type="Folder">
			<Item Name="Elapsed Times.vi" Type="VI" URL="../Elapsed Times.vi"/>
		</Item>
		<Item Name="Tests" Type="Folder">
			<Item Name="TestMotorsForwarda.vi" Type="VI" URL="../TestMotorsForwarda.vi"/>
		</Item>
		<Item Name="Robot Main.vi" Type="VI" URL="../Robot Main.vi"/>
		<Item Name="SquareInputs.vi" Type="VI" URL="../SquareInputs.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Test-DriveForwardDistance-DML.vi" Type="VI" URL="../Tests/Test-DriveForwardDistance-DML.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Bld_localDestDir" Type="Path">/D/Temp/LabView Builds</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{770E1AA2-D38D-4DDA-85BE-285A7A7E1559}</Property>
